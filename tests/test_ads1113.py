...
from feeph.ads1xxx.ads111x import DEFAULTS
...
class TestAds1113(unittest.TestCase):
    ...
    def test_singleshot_measurement_default(self):
        ...
        # -----------------------------------------------------------------
        computed = self.Ads1113.get_singleshot_measurement(unit=UNIT.STEPS)
        expected = 0x1234
        # -----------------------------------------------------------------
    ...
    def test_singleshot_measurement_in_microvolts(self):
        ...
        # -----------------------------------------------------------------
        computed = self.Ads1113.get_singleshot_measurement()
    ...
    def test_singleshot_measurement_with_config(self):
        ...
        self.Ads1113.get_singleshot_measurement(config=config)
        # -----------------------------------------------------------------
        with BurstHandler(i2c_bus=self.i2c_bus, i2c_adr=self.i2c_adr) as bh:
    ...
    def test_singleshot_measurement_continued(self):
        config = sut.Ads1113Config()
        self.Ads1113.get_singleshot_measurement(config=config)
        self.Ads1113.get_singleshot_measurement()  # use same config as previous read
        # -----------------------------------------------------------------
        with BurstHandler(i2c_bus=self.i2c_bus, i2c_adr=self.i2c_adr) as bh:
            computed = bh.read_register(0x01, byte_count=2)
        expected = [0x0583, 0x8583]
    ...
    def test_singleshot_measurement_conflict1(self):
        ...
        self.assertRaises(RuntimeError, self.Ads1113.get_singleshot_measurement, config=config_ccm)
    ...
    def test_singleshot_measurement_conflict2(self):
        ...
        self.assertRaises(RuntimeError, self.Ads1113.get_singleshot_measurement)
